package pokerai.pokerbots.common.supersonic.generator;

import java.io.File;

import com.biotools.meerkat.Hand;

import pokerai.pokerbots.common.supersonic.LookupHandEvaluator;
...
public class Tester {
  ...
  public static void main(String[] args) {
		evaluator = LookupHandEvaluator.getInstance("math" + File.separator + "HandRanks.dat");
