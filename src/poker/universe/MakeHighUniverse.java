...
public class MakeHighUniverse extends MakeUniverse {
		...
		for(c1=ace;c1>=duece;c1--)
			for(c4=ace;c4>=duece;c4--)
				if(c1!=c4) {
					...
					;
					c5=c4;
					f52=Cards.c(4,3)*Cards.c(4,2);
					if(c1==ace) {
						j=1;
						fj=j*Cards.c(4,2)*Cards.c(4,2);
					} else {
						if(c4==ace) j=1;
						else j=0;
						fj=j*Cards.c(4,3)*4;
			...
			for(c4=ace;c4>=trey;c4--)
				for(c5=c4-1;c5>=duece;c5--)
					if(c4!=c1&&c5!=c1) {
						...
						if(c1==ace) {
							j=1;
							fj=j*Cards.c(4,2)*4*4;
						} else {
							if(c4==ace) j=1;
							else j=0;
							fj=j*Cards.c(4,3)*Cards.c(4,1);
						}
						put();
					}
	}
			...
			for(c3=c1-1;c3>=duece;c3--)
				for(c5=ace;c5>=duece;c5--)
					if(c5!=c1&&c5!=c3) {
						c2=c1;
						c4=c3;
						f52=Cards.c(4,2)*Cards.c(4,2)*4;
						if(c1==ace) {
							j=1;
							fj=Cards.c(4,1)*Cards.c(4,2)*4;
						} else {
							if(c5==ace) j=1;
							else j=0;
							fj=j*Cards.c(4,2)*Cards.c(4,2);
	...
	private static boolean includeSummary=true;
}
