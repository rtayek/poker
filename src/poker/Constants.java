...
public class Constants { // make this an enum?
	...
	public static final int flushes=(int)Cards.c(ranks,5);
	public static final int nonFlushes=(int)Cards.c(ranks+5-1,5); // non flushes (includes 5 of a kinds) https://en.wikipedia.org/wiki/Combination#Number_of_combinations_with_repetition
	public static final int wild=(int)Cards.c(ranks,1); // five of a kinds
	...
	public static final int naturalFiveCardCombinations=(int)Cards.c(52,5);
	public static final int allFiveCardCombinationsWithOneJoker=(int)Cards.c(53,5);
}
